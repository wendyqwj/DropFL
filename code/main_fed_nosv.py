...
from models.Fed import FedAvg,Krum
...
class FedTrain():
    ...
    def oneEpoch(self, args, idxs_users):
        ...
        if len(self.w_locals):
            ...
            self.w_glob = Krum(self.w_locals, args.num_users * args.frac,
            math.ceil(args.num_users * args.frac * args.alpha * args.delta))
...
if __name__ == '__main__':
    ...
    # 输出到文件
    fh = logging.FileHandler('./log/runlog_nosv_{}_{}_epo{}_n{}_C{}_a{}_d{}_iid{}_P_{}_{}.log'.format(args.dataset, args.model,
    ...
    # 基于SV的攻击运行时间太慢，这里先不测试sv dropout
    ...
    # fedList = [fed0, fed1, fed2, fed3]
    fedList = [fed0, fed1, fed2]
